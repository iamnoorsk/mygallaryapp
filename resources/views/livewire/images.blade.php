    ...
    <div class="sub-container">
        ...
        @foreach($images as $key => $image)
            <div class="image-container">
                <img src="{{ asset('storage/'.$image->path) }}" wire:click="storeKey({{$key}},{{$image->id}})" class="image"/>
