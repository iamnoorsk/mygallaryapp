            ...
            @if(!empty($key))
                <div class="modal-img-container">
                    ...
                    <div class="menu-container">
                        ...
                        <p style="padding-top:5px;">&nbsp; | By <span style="text-decoration:underline;cursor: pointer;" wire:click="filterByUser('{{$images[$key-1]->user->email}}')">{{ $images[$key-1]->user->name }}</span></p>
                    </div>
                </div>
            @endif
        </div>
